  ...
  return (
    <nav style={signin ? {display: 'none'} : signup ? {display: 'none'} : null}>
          <div className='first-block'>
             <div style={catalog ? {color: '#E0BEA2'} : productPage ? {color: '#E0BEA2'} : order ? {color: '#E0BEA2'} : favourite ? {color: '#E0BEA2'} : contacts ? {color: '#E0BEA2'} : exchange ? {color: '#E0BEA2'}  : null} onClick={(e) => setIsOpen(!isOpen)}  className='hamburger' >
                <Hamburger />
              </div>
                <Link style={catalog ? {color: 'black'} : productPage ? {color: 'black'} : order ? {color: 'black'} : favourite ? {color: 'black'} : contacts ? {color: 'black'} : exchange ? {color: 'black'} : null}>NEW</Link>
                <Link style={catalog ? {color: 'black'} : productPage ? {color: 'black'} : order ? {color: 'black'} : favourite ? {color: 'black'} : contacts ? {color: 'black'} : exchange ? {color: 'black'} : null} to='/catalog'>КАТАЛОГ</Link>
                <Link style={catalog ? {color: 'black'} : productPage ? {color: 'black'} : order ? {color: 'black'} : favourite ? {color: 'black'} : contacts ? {color: 'black'} : exchange ? {color: 'black'} : null}>О НАС</Link>
          </div>
          {isOpen && (
            ...
            <div className='second-block'>
                <h1 onClick={() => navigate('/catalog')} style={catalog ? {color: '#E0BEA2'} : productPage ? {color: '#E0BEA2'} : order ? {color: '#E0BEA2'} : favourite ? {color: '#E0BEA2'} : contacts ? {color: '#E0BEA2'} : exchange ? {color: '#E0BEA2'} : null} className='h1'>YANKI</h1>
            </div>
            ...
            <div className='fourth-block'>
                ...
                <img className='disappear' onClick={() => signOut(auth)} src={catalog ? userYellow : productPage ? userYellow : order ? userYellow : favourite ? userYellow : contacts ? userYellow : exchange ? userYellow : User} alt='' />
                <img onClick={() => navigate("/favourite")} src={catalog ? loveYellow : productPage ? loveYellow : order ? loveYellow : favourite ? loveYellow : contacts ? loveYellow : exchange ? loveYellow : Love} alt='' />
                <div className='numberofitemss'>{sizes}</div>
                <img onClick={() => navigate("/order")} src={catalog ? cartYellow : productPage ? cartYellow : order ? cartYellow : favourite ? cartYellow : contacts ? cartYellow : exchange ? cartYellow : Cart} alt='' />
