    ...
    <nav style={signin ? {display: 'none'} : signup ? {display: 'none'} : null}>
          ...
          {isOpen && (
            ...
            <div className='fourth-block'>
                <img onClick={() => setInput(input => !input)} className='disappear' src={catalog ? searchBlack : productPage ? searchBlack : order ? searchBlack : favourite ? searchBlack : contacts ? searchBlack : exchange ? searchBlack : delivery ? searchBlack : Search} alt='' />
