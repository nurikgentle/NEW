    ...
    <div className="exchange">
      ...
      <div className="exchangeInfo">
        <div className="exchangeInfoContainer">
          ...
          <p className="one">Обмен и возврат возможен в случае :</p>
        </div>
      </div>
      <div className="icons">
        <div className="iconItem">
          ...
          <p>
            если заказ не был использован и сохранил товарный вид(в том числе не нарушены бирки,
            ярлыки, упаковочные материалы)
          </p>
        </div>
        <div className="iconItem">
          <svg
